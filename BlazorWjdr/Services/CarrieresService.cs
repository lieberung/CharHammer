...
#pragma warning restore CS8629 // Nullable value type may be null.
        ...
        private int CalculScoreMartial(CarriereDto carriere)
        {
            ...
            score += carriere.CompetencesPourScore.Count(c=> c ==  _competencesEtTalentsService.CompetenceLangSecretBataille) * 2;
        ...
        private int CalculScoreMartialAuContact(CarriereDto carriere)
        {
            ...
            score += carriere.TalentsPourScore.Count(c => 
              ...
              || (c.Parent == _competencesEtTalentsService.TalentGroupeMaitrise && _competencesEtTalentsService.TalentsMaitriseAuContact.Contains(c))
            ) * 2;
        ...
        public List<CarriereDto> Folie => new()
        {
            GetCarriere(209), // Tueur de morts
            GetCarriere(213), // Fouet de dieu
            GetCarriere(170), // Flagellant
            GetCarriere(45),  // Fanatique
            GetCarriere(212), // Pénitent
            GetCarriere(88),  // Prêcheur de rue
            GetCarriere(198), // Tueur de démons
            GetCarriere(199), // Tueur de géants
            GetCarriere(77),  // Tueur de trolls
            GetCarriere(87),  // Exécuteur
            GetCarriere(268), // Mystique
            GetCarriere(268), // Cénobite
        };
    }
}
