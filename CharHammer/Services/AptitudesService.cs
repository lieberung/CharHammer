...
public class AptitudesService
{
    ...
    public AptitudesService(IReadOnlyDictionary<int, AptitudeDto> data)
    {
        ...
        AllTraits = AllAptitudes.Where(a => a.EstUnTrait);
    ...
    public IEnumerable<AptitudeDto> AllTraits { get; }
    ...
    public IEnumerable<AptitudeDto> Nevroses { get; }
    public IEnumerable<AptitudeDto> Addictions { get; }
    public IEnumerable<AptitudeDto> Alergies { get; }
    public IEnumerable<AptitudeDto> Phobies { get; }
